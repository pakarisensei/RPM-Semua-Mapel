      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 pt-2 border-t border-slate-100">
            <label className="block">
              <span className="text-slate-700 font-medium">Tempat TTD (Kota)</span>
              <input required type="text" className="mt-1 block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 py-3" value={formData.tempat} onChange={(e) => updateField('tempat', e.target.value)} placeholder="Contoh: Jakarta" />
            </label>
            <label className="block">
              <span className="text-slate-700 font-medium">Tanggal TTD</span>
              <input required type="date" className="mt-1 block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 py-3" value={formData.tanggal} onChange={(e) => updateField('tanggal', e.target.value)} />
            </label>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <label className="block">
              <span className="text-slate-700 font-medium">Jurusan / Kompetensi</span>
              <input 
                type="text" 
                className="mt-1 block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 py-3" 
          ...
          <div className="grid grid-cols-2 gap-4">
            <label className="block">
              ...
              <select className="mt-1 block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 py-3" value={formData.semester} onChange={(e) => updateField('semester', e.target.value)}>
                <option value="Ganjil">Ganjil</option>
                <option value="Genap">Genap</option>
              </select>
            </label>
            <label className="block">
              <span className="text-slate-700 font-medium">Tahun Pelajaran</span>
              <select className="mt-1 block w-full rounded-xl border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 py-3" value={formData.tahunPelajaran} onChange={(e) => updateField('tahunPelajaran', e.target.value)}>
